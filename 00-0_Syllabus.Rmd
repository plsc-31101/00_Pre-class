...
* Time: Monday and Wednesdays, 1:30 pm – 3:10 pm
...
On __December 11 (1:30-3:30)__, we will have a **lightning talk session** where students can present their projects in a maximum 5-minute talk.
...
library("usethis")
use_course("plsc-31101/TBD") # fix me
```

These materials are also available on this website: https://plsc-31101.github.io/course/. Students will be assigned reading from these notes before every class.

#### Canvas and Piazza {-}

We will use Canvas for turning in assignments. 

We will use [Piazza](piazza.com/uchicago/fall2020/plsc31101/home) for communication (announcements and questions). You should ask questions about class material and assignments through the Piazza website so that everyone can benefit from the discussion. We encourage you to respond to each other’s questions as well. Questions of a personal nature can be emailed to us directly.

Find our Piazza class signup link at: http://piazza.com/uchicago/fall2020/plsc31101

#### Computer Requirements and Software {-}

See [Install Page](installation) page for detailed information on the software we'll be using. Please download and install the required software before the first class. 

We will be having an __InstallFest on Wednesday, September 30 from 9:30 to 11:30 am, on Zoom__ for those students experiencing difficulties downloading and installing the requisite software. 

If you have difficulties installing, please post an question on Piazza with details on what you're trying to install, what actions you took, any error messages, etc.
