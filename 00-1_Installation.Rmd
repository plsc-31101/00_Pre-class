...
For this class, please install R Version 3.6.3. You'll notice that this is not the most recent version, but it is more stable than the newer 4.0. If you use a Mac, this will require at least 10.11 (El Capitan) as your OS; if you use a PC, anything Windows 7 or later will be sufficient.
...
If you have trouble with installation, please come to the Installfest on **Wednesday, September 30 from 9:30 am to 11:30 am in Pick 504**.
